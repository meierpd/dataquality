...
CHECK_MAPPINGS: Dict[str, Tuple[str, str, str, Optional[str]]] = {
    ...
    "check_count_all_scenarios": ("Daten", "C27", "outcome_str", "D27"),
    "check_count_advers_scenarios": ("Daten", "C24", "outcome_str", "D24"),
    "check_count_existenzbedrohend_scenarios": ("Daten", "C25", "outcome_str", "D25"),
    "check_count_other_scenarios": ("Daten", "C26", "outcome_str", "D26"),
