...
CHECK_MAPPINGS: Dict[str, Tuple[str, str, str, Optional[str]]] = {
    ...
    # C32 is blank/separator in template
    "check_count_advers_scenarios": ("Daten", "C33", "outcome_str", "D33"),
    "check_count_existenzbedrohend_scenarios": ("Daten", "C34", "outcome_str", "D34"),
    "check_count_other_scenarios": ("Daten", "C35", "outcome_str", "D35"),
    "check_count_all_scenarios": ("Daten", "C36", "outcome_str", "D36"),
    "check_every_scenario_has_event": ("Daten", "C37", "outcome_str", "D37"),
    "check_count_scenarios_only_one_event": ("Daten", "C38", "outcome_str", "D38"),
    "check_count_scenarios_multiple_events": ("Daten", "C39", "outcome_str", "D39"),
    "check_every_scenario_has_risk": ("Daten", "C40", "outcome_str", "D40"),
    "check_count_scenarios_only_one_risk": ("Daten", "C41", "outcome_str", "D41"),
    "check_count_scenrios_multiple_risks": ("Daten", "C42", "outcome_str", "D42"),
    "check_business_planning_filled_three_years": ("Daten", "C43", "outcome_str", "D43"),
    "check_sst_filled_three_years": ("Daten", "C44", "outcome_str", "D44"),
    "check_tied_assets_filled_three_years": ("Daten", "C45", "outcome_str", "D45"),
    "check_provisions_filled_three_years": ("Daten", "C46", "outcome_str", "D46"),
    "check_liquidity_filled_three_years": ("Daten", "C47", "outcome_str", "D47"),
    "check_other_perspective_filled_three_years": ("Daten", "C48", "outcome_str", "D48"),
    "check_scenarios_business_planning_filled_three_years": ("Daten", "C49", "outcome_str", "D49"),
    "check_scenarios_sst_filled_three_years": ("Daten", "C50", "outcome_str", "D50"),
    "check_scenarios_tied_assets_filled_three_years": ("Daten", "C51", "outcome_str", "D51"),
    "check_scenarios_provisions_filled_three_years": ("Daten", "C52", "outcome_str", "D52"),
    "check_scenarios_liquidity_filled_three_years": ("Daten", "C53", "outcome_str", "D53"),
    "check_scenarios_other_perspective_filled_three_years": ("Daten", "C54", "outcome_str", "D54"),
    "check_count_longterm_risks": ("Daten", "C55", "outcome_str", "D55"),
    "check_treatment_of_qual_risks": ("Daten", "C56", "outcome_str", "D56"),
    "check_orsa_dokumentation_sufficient": ("Daten", "C57", "outcome_str", "D57"),
