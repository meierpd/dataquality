...
CHECK_MAPPINGS: Dict[str, Tuple[str, str, str, Optional[str]]] = {
    ...
    # All other checks start at C9 (shifted down by 5 rows from original C4)
    ...
    "check_count_number_mitigating_measures_other_effect": ("Daten", "C25", "outcome_str", "D25"),
    "check_count_number_mitigating_measures_risk_accepted": ("Daten", "C26", "outcome_str", "D26"),
    "check_count_other_measures": ("Daten", "C27", "outcome_str", "D27"),
    "check_count_potential_other_measures": ("Daten", "C28", "outcome_str", "D28"),
    "check_count_number_other_measures_other_effect": ("Daten", "C29", "outcome_str", "D29"),
    "check_risks_are_all_mitigated": ("Daten", "C30", "outcome_str", "D30"),
    "check_any_nonmitigating_measures": ("Daten", "C31", "outcome_str", "D31"),
    ...
    "check_other_perspective_filled_three_years": ("Daten", "C46", "outcome_str", "D46"),
    ...
    "check_scenarios_other_perspective_filled_three_years": ("Daten", "C52", "outcome_str", "D52"),
